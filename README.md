...
The r files are for preprocessing, removing duplicates, producing simple descriptives, and look for the optimal k (see also Lexisnexis_MASTER.R) as well as running the topic model.
The ipynb files are for preparing and implementing the few shot ML strategy to analyse various stances around the just transition. Also included is an xlsx output of the qualitative codes and coding structure from MAXQDA.

doi.org/10.5281/zenodo.20394762
